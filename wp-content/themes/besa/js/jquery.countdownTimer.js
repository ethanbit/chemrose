...
jQuery(window).on('elementor/frontend/init', function () {
  if (jQuery.isArray(besa_settings.elements_ready.countdowntimer)) {
    $.each(besa_settings.elements_ready.countdowntimer, function (index, value) {
      elementorFrontend.hooks.addAction('frontend/element_ready/besa-' + value + '.default', CountDownTimerHandler);
    });
  }
});
