...
class Tbay_Widget_Recent_Post extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'besa_recent_post',
            esc_html__('Besa Recent Posts', 'besa'),
            array( 'description' => esc_html__( 'Show list of recent post', 'besa' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'besa' ); ?></label>
