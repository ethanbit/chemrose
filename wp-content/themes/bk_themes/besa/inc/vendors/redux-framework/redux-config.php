            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id' => 'mobile_header',
                        'type' => 'switch',
                        'title' => esc_html__('Enable Mobile Header', 'besa'),
                        'default' => true
                    ),   
                    array(
                        'id' => 'mobile-logo',
                    ...
                    array(
                        ...
                        'type'      => 'switch',
                        'title'     => esc_html__('Hide Header Elementor Pro', 'besa'),
                        'subtitle'  => esc_html__('Hide Header Elementor Pro on mobile', 'besa'),
                        'default'   => true
                    ),
                )
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(       
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable WooCommerce Quantity Mode', 'besa'),
                        'subtitle' => esc_html__('Enable/Disable show quantity on Home Page and Shop Page', 'besa'),
                        'default' => false
                    ),                     
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'subtitle' => esc_html__('Enable/Disable Vendor Name on HomePage and Shop page only works for Dokan, WCMP Vendor', 'besa'),
                        'default' => true
                    ),  
                    array(
                        'id'        => 'show_vendor_name_wcmp',
                        'type'      => 'none',
                        'title'     => esc_html__('Enable Vendor Name Only WCMP Vendor', 'besa'),
                        'subtitle'  => sprintf(__('Go to the <a href="%s" target="_blank">Setting</a> Enable "Sold by" for WCMP Vendor', 'besa'), admin_url('admin.php?page=wcmp-setting-admin')),
                    ),
                    array(
                        'id'   => 'opt-divide',
                        'class' => 'big-divide',
