	...
	function besa_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			<?php if ( $main_color != "" ) : ?>
				...
				<?php /*color Fix Important*/ ?>
				 #wcfmmp-store .categories_list ul li.parent_cat a:hover, .product-block .wcfmmp_sold_by_wrapper a:hover {
					color: <?php echo esc_html($main_bg_color); ?> !important;
				}

				.dokan-theme-besa input[type="submit"].dokan-btn-theme, .dokan-theme-besa a.dokan-btn-theme, .dokan-theme-besa .dokan-btn-theme {
					background-color: <?php echo esc_html($main_bg_color); ?> !important;
					border-color: <?php echo esc_html($main_bg_color); ?> !important;
					outline: none;
				}
				.dokan-theme-besa input[type="submit"].dokan-btn-theme:hover,
	            .dokan-theme-besa a.dokan-btn-theme:hover,
	            .dokan-theme-besa .dokan-btn-theme:hover,
	            .dokan-theme-besa input[type="submit"].dokan-btn-theme:focus,
	            .dokan-theme-besa a.dokan-btn-theme:focus,
	            .dokan-theme-besa .dokan-btn-theme:focus,
	            .dokan-theme-besa input[type="submit"].dokan-btn-theme:active,
	            .dokan-theme-besa a.dokan-btn-theme:active,
	            .dokan-theme-besa .dokan-btn-theme:active,
	            .dokan-theme-besa input[type="submit"].dokan-btn-theme.active,
	            .dokan-theme-besa a.dokan-btn-theme.active,
	            .dokan-theme-besa .dokan-btn-theme.active,
	            .dokan-theme-besa .open .dropdown-toggleinput[type="submit"].dokan-btn-theme,
	            .dokan-theme-besa .open .dropdown-togglea.dokan-btn-theme,
	            .dokan-theme-besa .open .dropdown-toggle.dokan-btn-theme {
					background-color: <?php echo esc_html( besa_tbay_color_lightens_darkens( $main_bg_color, -0.1) ); ?> !important;
					border-color: <?php echo esc_html( besa_tbay_color_lightens_darkens( $main_bg_color, -0.1) ); ?> !important;
	        	}
