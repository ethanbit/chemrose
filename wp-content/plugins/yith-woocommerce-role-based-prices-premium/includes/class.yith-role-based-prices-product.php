...
if ( !class_exists( 'YITH_Role_Based_Prices_Product' ) ) {
    ...
    class YITH_Role_Based_Prices_Product {
        ...
        public function __construct() {
            ...
            add_action( 'woocommerce_single_product_summary', array( $this, 'remove_add_to_cart_with_request_a_quote' ), 10 );
        ...
        public function show_product_variation_price_rule( $loop, $variation_data, $variation ) {
            wc_get_template( 'metaboxes/product-variation-rules.php', array( 'loop' => $loop, 'variation_data' => $variation_data, 'variation' => $variation ), '', YWCRBP_TEMPLATE_PATH );
        ...
        public function is_custom_price( $product ){
            ...
            return $has_dynamic_price || $yith_wapo_adjust_price || is_array( $ywcp_composite_info ) || $is_gift_card;
        }
        ...
        public function get_simple_price_html( $product ) {
            ...
            if ( $regular_price === '' )
                $price = ''; elseif ( !$show_regular_price && !$show_on_sale_price && !$show_your_price ) {
                $price = '';
        ...
        public function get_regular_price_html( $product, $has_your_price = true ) {
            ...
            if ( $has_your_price || !empty( $sale_price ) && $regular_price !== $sale_price ) {
