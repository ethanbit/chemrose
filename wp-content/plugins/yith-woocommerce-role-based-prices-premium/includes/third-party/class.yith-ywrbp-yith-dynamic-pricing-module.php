...
if( !class_exists( 'YITH_WRBP_Dynamic_Pricing_Module' ) ) {
    ...
    class YITH_WRBP_Dynamic_Pricing_Module
    {
        ...
        {
            remove_filter( 'option_woocommerce_tax_display_shop', array( YITH_Role_Based_Prices_Product(), 'show_price_incl_excl_tax' ), 10 );
            remove_filter( 'option_woocommerce_tax_display_cart', array( YITH_Role_Based_Prices_Product(), 'show_price_incl_excl_tax' ), 10 );
