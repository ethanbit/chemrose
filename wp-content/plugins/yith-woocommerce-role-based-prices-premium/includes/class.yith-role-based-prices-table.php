    ...
    class YITH_Role_Based_Prices_Table extends WP_List_Table
    {
        ...
        public function __construct( $args )
        {
            parent::__construct( array(
                'singular' => _x( 'price rule', 'yith-woocommerce-role-based-prices' ),     //singular name of the listed records
                'plural' => _x( 'price rules', 'yith-woocommerce-role-based-prices' ),    //plural name of the listed records
        ...
        {
            $views = array( 'all' => __( 'All', 'yith-woocommerce-role-based-prices' ),
            ...
            switch ( $column_name ) {
                ...
                case 'type_price':
                    ...
                    if ( 'discount_val' === $price_type || 'markup_val' === $price_type ) {
                        ...
                        $price_value = wc_format_localized_price( $price_value );
                    } else {
        ...
        private function get_category_list( $categories_id ){
            ...
            if( !empty( $categories_id ) ){
                ...
                $categories_name = sprintf('<small>%s</small>', implode(',', $categories_name ) );
            }
        ...
        private function get_tag_list( $tags_id ){
            ...
            if( !empty( $tags_id ) ){
                ...
                $tag_name = sprintf('<small>%s</small>', implode(',', $tag_name ) );
            }
            return $tag_name;
        }
    }
