...
if ( !class_exists( 'YITH_Role_Based_Prices_Post_Type' ) ) {
    ...
    class YITH_Role_Based_Prices_Post_Type
    {
         ...
         * @return array
         */
        public function get_price_rule_by_product_categories( $product_categories,$product_id, $user_role = '' )
        {
            ...
            foreach ( $rule_cat as $rule_id ) {
                ...
                $rule_categories = get_post_meta( $rule_id, '_ywcrbp_category_product', true );
         ...
         * @return array
         */
        public function get_price_rule_by_product_tags( $product_tags, $product_id, $user_role = '')
        {
            ...
            foreach ( $rule_tag as $rule_id ) {
                ...
                $rule_tags = get_post_meta( $rule_id, '_ywcrbp_tag_product', true );
