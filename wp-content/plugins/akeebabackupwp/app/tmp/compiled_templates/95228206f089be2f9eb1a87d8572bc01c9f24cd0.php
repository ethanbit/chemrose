<?php /* /home/devchemrose/public_html/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Main/paypal.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div class="akeeba-panel--orange">
    ...
    <p>
        <?php if(!$this->getContainer()->segment->get('insideCMS', false)): ?>
            <a href="https://www.akeebabackup.com/landing/akeeba-solo.html" class="akeeba-btn--large--primary">
                <span class="aklogo-solo"></span>
                <?php echo \Awf\Text\Text::_('COM_AKEEBA_CONTROLPANEL_BTN_LEARNMORE'); ?>
            </a>
        <?php else: ?>
            <a href="https://www.akeebabackup.com/landing/akeeba-backup-wordpress.html"
