		...
		<div class="ced_ocor_email_main_content">
			...
			<div class="wramvp_main_content__col">
				...
				<div class="wramvp_img_banner">
					<a target="_blank" href="http://bit.ly/2LB1lZV"><img alt="market-place" src="<?php echo plugins_url().'/one-click-order-reorder/assets/images/market-place-2.jpg'?>"></a> 
				</div>
			</div><br>
			<div class="wramvp_main_content__col">
				<p> 
				...
				<div class="wramvp_img_banner">
					<a target="_blank" href="http://bit.ly/2LB71TJ"><img alt="market-place" src="<?php echo plugins_url().'/one-click-order-reorder/assets/images/market-place.jpg'?>"></a> 
				</div>
			</div>
...
public function ced_ocor_save_general_setting() {
	...
	$selectedUsers 	= isset( $_POST[ 'selectedUser' ] ) ? sanitize_text_field($_POST[ 'selectedUser' ]) : array();
	$basketEnable 	= isset( $_POST[ 'basketEnable' ] ) ? sanitize_text_field($_POST[ 'basketEnable' ]) : 'enable';
	$basketPages 	= isset( $_POST[ 'basketPages' ] ) ? sanitize_text_field($_POST[ 'basketPages' ]) : array( 'shop', 'detail' );
