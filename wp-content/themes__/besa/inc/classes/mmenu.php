...
if ( !class_exists("Besa_Tbay_mmenu_menu") ) {
    class Besa_Tbay_mmenu_menu extends Walker_Nav_Menu {
        ...
        public function generateSubMegaMenu( $item, $tbay_mega_profile ) {
            ...
            if ( $tbay_mega_profile ) {
                ...
                if ( $posts && isset($posts[0]) ) {
                    ...
                    if( defined('TBAY_ELEMENTOR_ACTIVED') && besa_is_elementor_activated() && in_array( 'tbay_megamenu', get_option( 'elementor_cpt_support' ) ) ) {
                    ...
                    $tbaymegamenu  = false;
                    return '<div class="sub-menu"><div class="dropdown-menu-inner">'.$content.'</div></div>';
                }
            }
            return '';
        }
