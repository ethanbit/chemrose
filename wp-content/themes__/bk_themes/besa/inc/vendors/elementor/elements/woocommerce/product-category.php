...
if ( ! defined( 'ABSPATH' ) || function_exists('Besa_Elementor_Product_Category') ) {
 ...
 * @since 1.0.0
 */
class Besa_Elementor_Product_Category extends  Besa_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Besa Product Category', 'besa' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__( 'Product Category', 'besa' ),
            ]
        );
        $this->add_control(
            'limit',
        ...
        $this->add_control(
            'feature_image',
            [
                'label'     => esc_html__('Feature Image', 'besa'),
    ...
    protected function register_button() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => esc_html__( 'Show More', 'besa' ),
                'condition' => [
                    'show_more' => 'yes'
                ]
            ]
...
$widgets_manager->register_widget_type(new Besa_Elementor_Product_Category());
