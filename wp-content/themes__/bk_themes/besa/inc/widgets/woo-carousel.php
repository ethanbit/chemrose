...
class Tbay_Widget_Woo_Carousel extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'besa_woo_carousel',
            esc_html__('Besa woocommerce Carousel', 'besa'),
            array( 'description' => esc_html__( 'Show list product', 'besa' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            ?>
            <label for="<?php echo esc_attr($this->get_field_id( 'categories' )); ?>"><?php esc_html_e( 'Please select category to show:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No woocommerce category found ', 'besa'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of products to show:', 'besa' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'types' )); ?>"><?php esc_html_e( 'Type Products:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose type product found ','besa'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns' )); ?>"><?php esc_html_e( 'Columns:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose columns product found ', 'besa'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_destsmall' )); ?>"><?php esc_html_e( 'Columns screen desktop small:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose columns desktop small product found ', 'besa'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_tablet' )); ?>"><?php esc_html_e( 'Columns screen tablet:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose columns table product found ','besa'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_mobile' )); ?>"><?php esc_html_e( 'Columns screen mobile:', 'besa' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'rows' )); ?>"><?php esc_html_e( 'Rows:', 'besa' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php echo esc_html__('No choose rows product found ','besa'); ?>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('navigations')); ?>" name="<?php echo esc_attr($this->get_field_name('navigations')); ?>" type="checkbox" value="1" <?php checked( $navigations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('navigations') ); ?>">
                <?php echo esc_html__('Show navigations','besa'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('paginations')); ?>" name="<?php echo esc_attr($this->get_field_name('paginations')); ?>" type="checkbox" value="1" <?php checked( $paginations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('paginations') ); ?>">
                <?php echo esc_html__('Show paginations','besa'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('loop_type')); ?>" name="<?php echo esc_attr($this->get_field_name('loop_type')); ?>" type="checkbox" value="1" <?php checked( $loop_type ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('loop_type') ); ?>">
                <?php echo esc_html__('Show loop','besa'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('auto_type')); ?>" name="<?php echo esc_attr($this->get_field_name('auto_type')); ?>" type="checkbox" value="1" <?php checked( $auto_type ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('auto_type') ); ?>">
                <?php echo esc_html__('Show auto','besa'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('disable_mobile')); ?>" name="<?php echo esc_attr($this->get_field_name('disable_mobile')); ?>" type="checkbox" value="1" <?php checked( $disable_mobile ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('disable_mobile') ); ?>">
                <?php echo esc_html__('Disable mobile','besa'); ?>
            </label>
