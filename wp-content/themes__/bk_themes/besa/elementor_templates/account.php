...
$url_login = apply_filters('besa_woocommerce_my_account_url', get_permalink(wc_get_page_id('myaccount') ) );

if( defined('BESA_WOOCOMMERCE_CATALOG_MODE_ACTIVED') && BESA_WOOCOMMERCE_CATALOG_MODE_ACTIVED ) return;
?>
